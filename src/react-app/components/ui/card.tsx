...
function Card({
  ...
  return (
    <div
      ...
      className={cn(
        "ring-foreground/10 bg-card text-card-foreground gap-6 overflow-hidden rounded-2xl py-6 text-sm ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 [&>img:first-child]:rounded-t-xl [&>img:last-child]:rounded-b-xl group/card flex flex-col transition-all duration-300 ease-out",
        interactive && "cursor-pointer hover:ring-foreground/20 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.01] active:scale-[0.98] active:translate-y-0",
        className
      )}
      {...props}
    />
